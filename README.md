...
- t.me/woa_msmnile_issues (if your question is not Surface Duo related, or concerns a specific third party OEM made phone, or is about the Snapdragon 8 Gen 2 BSP in general)
...
```
git clone -c core.autocrlf=false https://github.com/WOA-Project/windows_silicon_qcom_kona
```
